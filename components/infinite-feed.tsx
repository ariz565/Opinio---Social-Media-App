...
export function InfiniteFeed() {
  ...
  const fetchPosts = async () => {
    ...
    const newPosts: Post[] = Array.from({ length: POSTS_PER_PAGE }, (_, i) => ({
      ...
      content: `This is post number ${posts.length + i + 1}. Here's some interesting content about technology, innovation, and the future of web development. #tech #innovation #webdev`,
      image: Math.random() > 0.5 ? SAMPLE_IMAGES[Math.floor(Math.random() * SAMPLE_IMAGES.length)] : undefined,
